...
public class frmSplash{
    ...
    public frmSplash(int duration) {
        ...
        SplashImage = new JLabel(new ImageIcon(ClassLoader.getSystemResource("Images/proshanti.JPG")));
        SplashText=new JLabel("Shop Management System...",SwingConstants.CENTER);
