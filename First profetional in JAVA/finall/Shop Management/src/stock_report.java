...
class stock_report extends JInternalFrame {
    ...
    public stock_report() {
        ...
        reportingPanel.add(new JLabel("Stock Report"), BorderLayout.NORTH);
        ...
        cancel.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                //dispose();
             //   print(createBuffer());
//               PrintUtilities e1 = new PrintUtilities(this);
//        e1.print();
    ...
    private void printList() {
        try {
            ...
            ResultSet rst = DBConnection.getDBConnection().createStatement(
                    ...
                    ResultSet.CONCUR_UPDATABLE).executeQuery("select * from stock");
            listPane.append("\n");
            listPane.append("       Serial No" + "\t\t" + "Product ID" + "\t\t" + "Product Name" + "\t\t\t" + "Product Price (In Buy)\t\t" + "Product Price (In Sell)" + "\t\t" + "Quantity\n");
            listPane.append("\n");
            while (rst.next()) {
                listPane.append("       ");
