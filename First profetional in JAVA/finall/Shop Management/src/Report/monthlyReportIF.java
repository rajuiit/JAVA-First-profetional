...
setValueToCB();
    ...
    private void initComponents() {
        ...
        monthGraph = new javax.swing.JButton();
        ...
        monthGraph.setText("Monthly report Graph");
        monthGraph.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                monthGraphActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(monthGraph))
                    .addComponent(printButton, javax.swing.GroupLayout.DEFAULT_SIZE, 46, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void monthGraphActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_monthGraphActionPerformed
        // TODO add your handling code here:
...
//	dataset.setValue(6, "Marks", "Chandan");
	...
	JFreeChart chart = ChartFactory.createBarChart("Monthly Report Chart Month:"+ month1+", "+year1,"Product Name", "Quantity", dataset, PlotOrientation.VERTICAL, false,true, false);
	
        chart.setBackgroundPaint(Color.yellow);
	chart.getTitle().setPaint(Color.blue); 
	CategoryPlot p = chart.getCategoryPlot(); 
	p.setRangeGridlinePaint(Color.red); 
	ChartFrame frame1=new ChartFrame("Monthly Report Chart",chart);
	frame1.setVisible(true);
	frame1.setSize(400,350);
    }//GEN-LAST:event_monthGraphActionPerformed
    ...
    private javax.swing.JButton monthGraph;
